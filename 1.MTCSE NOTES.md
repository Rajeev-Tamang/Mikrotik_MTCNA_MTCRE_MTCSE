...
- Secure Socket Tunnelling protocol(sstp) is a form of vpn tunnel that provides a mechanismn to encapsulate PPP traffic over HTTPS(SSL/TLS) Channel. It is commanly used for secure remote access

- **This too is your excersie , try it your self.**
